...
\dfn{external pointer} referencing an internal object created by
native code.  Unfortunately, it is not a sufficient indicator, because
some objects with external pointers can be exported,
