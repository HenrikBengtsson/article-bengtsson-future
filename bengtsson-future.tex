...
first released supports this. As of March 2021, \pkg{foreach} is among
...
grown steadily ever since.  As of March 2021, \pkg{future} is among
the top-0.6\% most downloaded package on CRAN\footnote{The download
...
packages \pkg{future.apply} (top-2.1\% most downloaded)
and \pkg{furrr} (top 1.4\%), the corresponding number of packages are
