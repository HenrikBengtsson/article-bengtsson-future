...
the top-1.1\% most downloaded package on CRAN\footnote{The download
rankings are based on the download logs for the RStudio CRAN mirror.
The ranks are robust estimates based on the average median weekly
download during the most recent four weeks.} and there are 167
