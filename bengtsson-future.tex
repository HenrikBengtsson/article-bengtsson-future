...
specified, it defaults to \code{availableCores()}, which respect a
large number of environment variables and R options specifying the
number of cores.  Because of this, and due to the built-in protection
against nested parallelism, using
...
2014).  The core packages \pkg{future}, \CRANpkg{parallelly}~\citep{CRAN:parallelly}, \pkg{globals},
...
and
\pkg{furrr}, the corresponding number of packages are 71 and 40,
respectively.
